...
phiD=0.  #Driver phase
push=Xgrid[int(0.4*len(Xgrid))]+40. #Fine tune where the wakefield oscillations appear in the FDTD grid (Xgrid)
...
Profile = WKF.wake_bck(parameters,y0,setting='single') #Add the non-linear wakefield profile
